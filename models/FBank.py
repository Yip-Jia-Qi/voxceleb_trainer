import torch
try:
    from FilterBank import Filterbank, STFT, Deltas, ContextWindow, spectral_magnitude
except:
    from models.FilterBank import Filterbank, STFT, Deltas, ContextWindow, spectral_magnitude
