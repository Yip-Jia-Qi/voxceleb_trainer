...
parser.add_argument('--print_interval', type=int, default=10000, help='modify to limit printing out too many items in the log by the ModelTrainer training and evaluation functions.')
