...
parser.add_argument('--print_interval', type=int, default=999999, help='modify to limit printing out too many items in the log by the ModelTrainer training and evaluation functions.')
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    for it in range(it,args.max_epoch+1):
        ...
        loss, traineer = trainer.train_network(train_loader, verbose=False)#(args.gpu == 0))
